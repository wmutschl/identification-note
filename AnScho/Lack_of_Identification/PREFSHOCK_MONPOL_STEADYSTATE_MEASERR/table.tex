...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{R},{z}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{INT},{g}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_y ]$ & ${INFL},{INT},{z}$ \\
\hline
$\checkmark$ & err & $[\psi_y ]$ & ${INFL},{INT},{\zeta}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${INFL},{y},{c}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{R},{g}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${y},{R},{g}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${c},{\pi},{z}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_y \rho_R \sigma_R ]$ & ${c},{z},{\zeta}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${R},{\pi},{g}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_y ]$ & ${R},{\pi},{z}$ \\
\hline
$\checkmark$ & err & $[\psi_y ]$ & ${R},{\pi},{\zeta}$ \\
\hline
...
\hline
\caption{PREFSHOCK MONPOL STEADYSTATE MEASERR}
