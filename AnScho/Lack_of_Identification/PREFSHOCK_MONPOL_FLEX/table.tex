...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${R},{\pi}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL},{c}$ \\
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${YGR},{INFL},{R}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL},{\pi}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{\pi}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${INT},{\pi},{g}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${R},{\pi},{g}$ \\
\hline
