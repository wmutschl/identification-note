...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${y},{\pi}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${\pi},{\zeta}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL},{g}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL},{z}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{y},{z}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${INT},{y},{g}$ \\
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${INT},{y},{z}$ \\
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${INT},{y},{\zeta}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${c},{\pi},{g}$ \\
\hline
