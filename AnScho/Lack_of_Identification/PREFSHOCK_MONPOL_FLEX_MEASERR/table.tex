...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_y \rho_R ]$ & ${YGR},{R}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INT},{\pi}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${R},{\pi}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{R},{\zeta}$ \\
\hline
...
\hline
$[\psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{R}$ \\
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{INT},{\pi}$ \\
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{g}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_y ]$ & ${INFL},{INT},{z}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{\zeta}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{R},{\pi}$ \\
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{R},{g}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y ]$ & ${INT},{c},{z}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INT},{\pi},{g}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${R},{\pi},{g}$ \\
\hline
...
\hline
\caption{PREFSHOCK MONPOL FLEX MEASERR}
