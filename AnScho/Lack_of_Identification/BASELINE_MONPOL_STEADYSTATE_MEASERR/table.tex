...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INT},{y}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INT},{g}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y ]$ & ${YGR},{y},{R}$ \\
\hline
$\checkmark$ & err & $\checkmark$ & ${YGR},{y},{\pi}$ \\
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\rho_R \sigma_R ]$ & ${YGR},{y},{g}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y ]$ & ${YGR},{g},{z}$ \\
\hline
...
\hline
\caption{BASELINE MONPOL STEADYSTATE MEASERR}
