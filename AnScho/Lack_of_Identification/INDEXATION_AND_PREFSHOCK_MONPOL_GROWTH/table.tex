...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${YGR},{g}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $\checkmark$ & ${YGR},{g},{\zeta}$ \\
\hline
...
\hline
$\checkmark$ & err & $\checkmark\checkmark$ & ${INFL},{y},{\pi}$ \\
\hline
...
\hline
$\checkmark$ & err & $\checkmark\checkmark$ & ${INFL},{c},{g}$ \\
\hline
$\checkmark$ & err & $\checkmark\checkmark$ & ${INFL},{c},{z}$ \\
\hline
$\checkmark$ & err & $\checkmark$ & ${INFL},{c},{\zeta}$ \\
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${INFL},{R},{\pi}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $\checkmark\checkmark$ & ${INT},{\pi},{z}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INT},{\pi},{\zeta}$ \\
\hline
$\checkmark$ & err & $\checkmark$ & ${INT},{g},{z}$ \\
\hline
$\checkmark$ & err & $\checkmark$ & ${INT},{g},{\zeta}$ \\
\hline
