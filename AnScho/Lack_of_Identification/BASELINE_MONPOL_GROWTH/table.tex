...
\hline
$\checkmark$ & err & $\checkmark\checkmark$ & ${INFL},{y}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{INFL},{\pi}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${YGR},{INT},{z}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${YGR},{R},{z}$ \\
\hline
...
\hline
$\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{y},{\pi}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${INT},{y},{c}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${INT},{y},{z}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${y},{c},{R}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${y},{R},{g}$ \\
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${y},{R},{z}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & $\checkmark\checkmark$ & ${c},{R},{g}$ \\
\hline
