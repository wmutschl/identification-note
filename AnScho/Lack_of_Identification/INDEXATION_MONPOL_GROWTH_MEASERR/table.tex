...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_y \sigma_R ]$ & ${y},{c}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_y \rho_R \sigma_R ]$ & ${INFL},{c},{\pi}$ \\
\hline
$\checkmark$ & err & $\checkmark$ & ${INFL},{c},{g}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${INFL},{c},{z}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${y},{c},{g}$ \\
\hline
...
\hline
\caption{INDEXATION MONPOL GROWTH MEASERR}
