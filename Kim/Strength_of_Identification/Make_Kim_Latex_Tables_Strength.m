...
for strength_table_model = [{'BaselineLevel'}, {'BaselineGrowth'}, {'InvestshockLevel'}, {'InvestshockGrowth'}]
    ...
    for strres = {'hessian', 'mcmc'}            
        ...
        inputTbl.tableCaption = ['Bayesian Weak Identification Kim ', strres{:} ' method'];
        inputTbl.tableLabel = ['tbl:WeakKim_', strres{:}];
        filenam = ['table_KimWeak_', strres{:},'.tex'];
